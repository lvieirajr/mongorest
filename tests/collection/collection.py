...
class TestCollection(TestCase):
    ...
    @patch('mongorest.collection.Collection.after_validation_succeeded')
    def test_init_doesnt_call_after_validation_succeeded_if_validation_succeeds_and_after_validation_returns_something(self, after_validation_succeeded):
        self.collection.after_validation = lambda self: True
    ...
    @patch('mongorest.collection.Collection.after_update')
